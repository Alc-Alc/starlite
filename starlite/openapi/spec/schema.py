...
from starlite.utils.predicates import is_non_string_sequence

if TYPE_CHECKING:
    from starlite.openapi.spec.discriminator import Discriminator
    ...
    from starlite.openapi.spec.xml import XML
